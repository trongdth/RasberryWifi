...
class WifiTestCase(unittest.TestCase):
    ...
    @mock.patch("wifi.RasberryWifi._cmd_list_network")
    ...
    @mock.patch("wifi.RasberryWifi._cmd_add_network")
    ...
    @mock.patch("wifi.RasberryWifi._cmd_add_ssid")
    ...
    @mock.patch("wifi.RasberryWifi._cmd_add_psk")
    ...
    @mock.patch("wifi.RasberryWifi._cmd_add_ssid")
    @mock.patch("wifi.RasberryWifi._cmd_add_psk")
    @mock.patch("wifi.RasberryWifi._cmd_enable_network")
    @mock.patch("wifi.RasberryWifi._cmd_select_network")
    @mock.patch("wifi.RasberryWifi._cmd_save_config")
    @mock.patch("wifi.RasberryWifi._cmd_reconfigure_network")
